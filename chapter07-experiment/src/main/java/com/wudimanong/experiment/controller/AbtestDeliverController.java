...
public class AbtestDeliverController {
    ...
    public AbtestExpInfoPO findByFactorTag(@RequestParam("factorTag") String factorTag) throws InterruptedException {
        ...
        AbtestExpInfoPO abtestExpInfoPO2 = abtestExpInfoServiceImpl.getExpInfoByFactorTag(factorTag);
        ...
        AbtestExpInfoPO abtestExpInfoPO3 = abtestExpInfoServiceImpl.getExpInfoByFactorTag(factorTag);
        long endTime3 = System.currentTimeMillis();
        System.out.println("第三次次耗时（从数据库获取）->" + (endTime3 - startTime3) + " 毫秒");

        Long startTime4 = System.currentTimeMillis();
        AbtestExpInfoPO abtestExpInfoPO4 = abtestExpInfoServiceImpl.getExpInfoByFactorTag(factorTag);
