        ...
        <div class="container fn-clear">
            <ul class="container-left">
                <li class="container-left-item container-left-first">
                    <a href="https://www.baidu.com" class="on" target="_blank">无敌码农统一授权中心</a>
                </li>
            </ul>
            <ul class="container-right">
                <li class="container-right-item"><a href="https://www.baidu.com/" target="_blank"
                                                    title="统一授权中心首页">统一授权中心首页</a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="authcenter-body fn-clear">
        <div class="authcenter-body-login">
            ...
            <div class="login login-modern " id="J-login">
                <form name="loginForm" id="login" action="/oauth/login" method="post" class="ui-form"
...
<div class="authcenter-foot" id="J-authcenter-foot">
    <div class="authcenter-foot-container">
        <p class="authcenter-foot-link">
            <a href="https://www.baidu.com">关于无敌码农</a>
        </p>
        <div class="copyright">
            <a href="" target="_blank">Copyright©&nbsp;&nbsp;微信公众号无敌码农</a>
        </div>
    </div>
</div>
</body>
